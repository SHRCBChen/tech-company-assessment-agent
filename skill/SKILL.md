...
description: 批量导入科创企业或项目名单及大赛现场自由笔记（支持同一Excel或名单与笔记分开上传并按企业/项目名称匹配），逐家完成主体映射、六轮公开深检和跨列事实提取，并由同一事实记录生成11类企业信息Excel、ima当前事实底稿及1—2页企业初评报告；也支持导入分支行拜访记录或企业材料后同步更新三类成果。适用于“导入企业名单后一键检索”“名单和现场笔记分开上传”“交付三件成果”“继续上次批次”“拜访后更新Excel/知识库/报告”等任务。
---
...
- 新名单：支持企业/项目名称与现场笔记在同一Excel同一行，也支持企业名单和现场笔记分成两个Excel/CSV上传。分开上传时，笔记文件必须有可与名单匹配的企业/项目名称列；按规范化名称一对一绑定，未匹配笔记、重名冲突和缺失笔记必须显式列出，不得猜测或错配。现场笔记是首批高价值材料，不是后续增量或“企业交流记录”。
