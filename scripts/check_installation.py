...
def main() -> None:
    ...
    checks = {
        ...
        "v4_channel_source_binding": "checked_with_sources" in strict_text and '"source_ids"' in schema_text,
        "v4_historical_financing_gate": "historical_financing_scan" in strict_text and "historical_financing_scan" in schema_text,
        "v4_relationship_boundary": "relationship_subject" in strict_text and "relationship_subject" in schema_text,
    }
